...
public class StaticShader extends ShaderProgram {
	// file locations
	private static final String VERTEX_FILE = "/graphics/shaders/vertexShader.txt";
	private static final String FRAGMENT_FILE = "/graphics/shaders/fragmentShader.txt";
	// uniforms
